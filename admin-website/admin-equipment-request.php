...
<head>
    ...
    <script src="/backend/view-equipment.js" defer></script>
...
<?php endif; ?>
    ...
    <tbody>
    <?php
        $query = "SELECT id, name, address, item_type, reason, request_date, status FROM equipment_requests ORDER BY id ASC";
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo "<td>
            <button class='view-btn' onclick='viewRequest(" . $row["id"] . ", \"" . htmlspecialchars($row["name"]) . "\", \"" . htmlspecialchars($row["address"]) . "\", \"" . htmlspecialchars($row["item_type"]) . "\", \"" . htmlspecialchars($row["reason"]) . "\", \"" . date("Y-m-d", strtotime($row['request_date'])) . "\", \"" . htmlspecialchars($row["status"]) . "\")'>
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                <label for="view_item_type">Equipment Type:</label>
                <input type="text" id="view_item_type" readonly>
            </div>
            <div class="form-group">
